...
<p align="center">
  <img src="images/demo.gif" alt="자율주행 데모" width="400">
</p>
...
하드웨어 배선의 경험 부족으로 인해 일부 부품이 정상적으로 동작하지 않는 문제가 반복 발생

| 곤란했던 점 | 해결책 |
|------------|--------|
| 전압/전류의 흐름에 대한 이해 부족으로 인한 배선 실수 | 배선도를 직접 설계하고, 신호의 흐름을 시각적으로 정리 |
| 복잡한 접속 구조를 정확하게 파악하기 어려움 | 각 부품의 접속을 단계적으로 확인하고, 실수를 최소화 |

→ **H/W 구조를 체계적으로 정리**할 필요성을 인식 → **안정적인 하드웨어 접속 구성을 구축**
